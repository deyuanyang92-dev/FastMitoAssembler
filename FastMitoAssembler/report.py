...
def generate_mm_report(output_path, sample, cfg, tool_envs=None):
    ...
    params = {
        ...
        'kmer_size':          cfg.get('novoplasty_kmer_size', 33),
        'genome_min_size':    cfg.get('novoplasty_genome_min_size', 12000),
        'genome_max_size':    cfg.get('novoplasty_genome_max_size', 22000),
        'max_mem_gb':         cfg.get('novoplasty_max_mem_gb', 10),
        'organelle_database': cfg.get('organelle_database', 'animal_mt'),
        'genetic_code':       cfg.get('genetic_code', 5),
        'clade':              cfg.get('mitoz_clade', 'Annelida-segmented-worms'),
